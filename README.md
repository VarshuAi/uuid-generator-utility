...
1. **Clone the repository:**
   ```bash
   git clone https://github.com/VARSHAN69/uuid-generator-utility.git
   cd uuid-generator-utility
   ```
...
[![Repo](https://img.shields.io/badge/uuid-generator-utility-Repo-00CC66?style=for-the-badge&logo=github&logoColor=black)](https://github.com/VarshuAi/uuid-generator-utility)
